...
Begin VB.Form frmBooking 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cmbClass 
         BackColor       =   &H00C0FFFF&
         Height          =   360
         ItemData        =   "frmBooking.frx":73B9
         Left            =   1560
         List            =   "frmBooking.frx":73C6
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Top             =   720
         Width           =   1695
      ...
      Begin VB.ComboBox cmbTheaterNo 
         BackColor       =   &H00C0FFFF&
         Height          =   360
         ItemData        =   "frmBooking.frx":73E5
         Left            =   1560
         List            =   "frmBooking.frx":73F2
         Style           =   2  'Dropdown List
         TabIndex        =   39
         Top             =   240
         Width           =   1695
...
Private Sub cmdSave_Click()
    ...
    Adodc1.Recordset.Open SQL, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & App.Path & "\Multiplex.mdb;Persist Security Info=False"
    Set lblBind.DataSource = Adodc1
    Set DataReport4.Sections("SectionHeader").Controls("Image1").Picture = LoadPicture("D:\#Sahil\Study Materials Chiki\Multiplex Ticket Booking System\Multiplex Ticket Booking System.1.jpg")
