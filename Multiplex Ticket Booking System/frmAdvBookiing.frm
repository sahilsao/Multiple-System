...
Begin VB.Form frmAdvBookiing 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Index           =   1
      Left            =   3600
      Picture         =   "frmAdvBookiing.frx":0000
      ScaleHeight     =   3315
      ScaleWidth      =   7995
      TabIndex        =   67
      Top             =   -960
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cmbTheaterNo 
         BackColor       =   &H00C0FFFF&
         Height          =   315
         ItemData        =   "frmAdvBookiing.frx":73B9
         Left            =   1560
         List            =   "frmAdvBookiing.frx":73C6
      ...
      Begin VB.ComboBox cmbClass 
         BackColor       =   &H00C0FFFF&
         Height          =   315
         ItemData        =   "frmAdvBookiing.frx":73D3
         Left            =   1560
         List            =   "frmAdvBookiing.frx":73E0
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   840
         Width           =   1695
   ...
   Begin VB.Image Image2 
      Height          =   495
      Left            =   6480
      Picture         =   "frmAdvBookiing.frx":73FF
      Top             =   4320
      Width           =   3750
   End
End
Attribute VB_Name = "frmAdvBookiing"
...
Private Sub cmbShowTime_Click()
    ...
    tCounter = 0
    SQL = "Select * from Booking order by ShowDate"
    Adodc1.Recordset.Close
    Adodc1.Recordset.Open SQL, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & App.Path & "\Multiplex.mdb;Persist Security Info=False"
    Set lblBind.DataSource = Adodc1
    With Adodc1.Recordset
        ...
        While .EOF <> True
            If .Fields(1) = cmbTheaterNo.ListIndex + 1 Then
                If Format(.Fields(2), "DD/MM/YYYY") = Format(AdvBookDate, "DD/MM/YYYY") Then
...
Private Sub cmdSave_Click()
    ...
    With Adodc1.Recordset
        ...
        .Fields(2) = Format(AdvBookDate, "DD/MM/YYYY")
        .Fields(3) = cmbShowTime.Text
        .Fields(4) = "A" 'Current Booking
...
Private Sub Form_Load()
    lblDate.Caption = Format(AdvBookDate, "dddd, dd-MMMM-YYYY")
    Call DispSeats
...
Public Sub CalAmt()
    Booking = Booking + 1
    lblSeatsAvail.Caption = Seats
    lblAmount.Caption = X * Val(lblRate.Caption)
...
Public Sub MarkReserved(SNo As String)
    ...
    Next i
    X = 0
    lblSeatsAvail.Caption = Val(lblSeats.Caption) - tCounter
    Seats = Val(lblSeats.Caption) - tCounter
End Sub
